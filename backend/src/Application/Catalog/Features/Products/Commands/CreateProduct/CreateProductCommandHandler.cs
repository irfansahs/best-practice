...
public sealed class CreateProductCommandHandler(IAppDbContext db, ILanguageLookup languages) : IRequestHandler<CreateProductCommand, CreateProductResponse>
{
    public async Task<Result<CreateProductResponse>> Handle(CreateProductCommand request, CancellationToken cancellationToken)
    {
        ...
        var productResult = Product.Create(Guid.NewGuid(), skuResult.Value, priceResult.Value, request.CategoryId);
